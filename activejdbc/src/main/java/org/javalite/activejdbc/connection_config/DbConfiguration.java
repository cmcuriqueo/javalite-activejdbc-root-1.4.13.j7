...
public class DbConfiguration {
    ...
    /**
     * Provides a list of all connection wrappers corresponding to a current
     * environment.
     *
     * @return a list of all connection wrappers corresponding to a current
     * environment.
     */
    ...
    /**
     * Provides a list of all connection wrappers corresponding to a given
     * environment.
     *
     * @param env name of environment, such as "development", "production", etc.
     *
     * @return a list of all connection wrappers corresponding to a given
     * environment.
     */
    public static List<ConnectionSpecWrapper> getConnectionSpecWrappers(String env) {
        return (List<ConnectionSpecWrapper>) (connectionWrappers.get(env) == null ? new ArrayList<>() : connectionWrappers.get(env));
    }
     ...
     *
     * <ul>
     * <li>Only one database connection can be configured per environment (with
     * the exception of development and test connections only in development
     * environment)</li>
     * <li>Currently additional database parameters need to be specified as a
     * part of a database URL</li>
     * <li>Database connection named "test" in the database configuration file
     * is for "development" environment and is automatically marked for testing
     * (will be used during tests)</li>
     * <li>All connections specified in a property file automatically assigned
     * DB name "default"
     * </ul>
     *
     * @param file path to a file. Can be located on classpath, or on a file
     * system. First searched on classpath, then on file system.
     */
    public void loadConfiguration(String file) {
        ...
        try {
            ...
            for (String n : props.stringPropertyNames()) {
                environments.add(n.substring(0, n.lastIndexOf(".")));
